...
### Bước 1: Khởi tạo Cơ sở dữ liệu (Tự động)
Dự án tích hợp công nghệ **Auto-Migration**. Bạn không cần mở SSMS để chạy script thủ công. Chỉ cần máy tính đã cài đặt **SQL Server Express**, Bot sẽ tự động kiểm tra, tạo Database `EntradeX-Advisor` và các bảng dữ liệu ngay trong lần chạy đầu tiên.
